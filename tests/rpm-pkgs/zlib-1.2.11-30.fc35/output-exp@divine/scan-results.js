{
    "scan": {
        ...
        "store-results-to": "/home/kdudka/git/aufover-benchmark/workdir-for-sync/rpm-pkgs/zlib-1.2.11-30.fc35/divine/output",
        "time-created": "2021-12-20 15:48:57",
        "time-finished": "2021-12-20 16:00:09",
        "tool": "csmock",
        "tool-args": "'/usr/bin/csmock' '-o' '/home/kdudka/git/aufover-benchmark/workdir-for-sync/rpm-pkgs/zlib-1.2.11-30.fc35/divine/output' '-f' '/home/kdudka/git/aufover-benchmark/workdir-for-sync/rpm-pkgs/zlib-1.2.11-30.fc35/zlib-1.2.11-30.fc35.src.rpm' '-r' 'fedora-35-x86_64' '-t' 'divine' '--keep-going'",
        "tool-version": "csmock-3.3.0-1.fc34"
    },
    "defects": [
        {
        ...
        },
        {
            ...
            "events": [
                ...
                },
                {
                    ...
                    "line": 0,
                    "event": "#",
                    "message": "  234|->         *p = (Pos)(m >= wsize ? m - wsize : NIL);",
                    "verbosity_level": "1"
                },
                {
                    "file_name": "",
                    "line": 0,
                    "event": "#",
                    "message": "  235|           /* If n is not on any hash chain, prev[n] is garbage but",
                    "verbosity_level": "1"
                },
                {
                    "file_name": "",
                    "line": 0,
                    "event": "#",
                    "message": "  236|            * its value will never be used.",
                    "verbosity_level": "1"
                }
            ]
        }
