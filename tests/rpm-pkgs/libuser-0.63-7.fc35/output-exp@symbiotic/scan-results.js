{
    "scan": {
        ...
        "store-results-to": "/home/mockbuilder/aufover-benchmark/workdir-for-sync/rpm-pkgs/libuser-0.63-7.fc35/symbiotic/output",
        "time-created": "2023-01-30 11:08:51",
        "time-finished": "2023-01-30 12:15:37",
        "tool": "csmock",
        "tool-args": "'/usr/bin/csmock' '-o' '/home/mockbuilder/aufover-benchmark/workdir-for-sync/rpm-pkgs/libuser-0.63-7.fc35/symbiotic/output' '-f' '/home/mockbuilder/aufover-benchmark/workdir-for-sync/rpm-pkgs/libuser-0.63-7.fc35/libuser-0.63-7.fc35.src.rpm' '-r' 'fedora-35-x86_64' '-t' 'symbiotic' '--symbiotic-timeout=8' '--keep-going'",
    ...
    "defects": [
        {
            ...
            "events": [
                ...
                },
                {
                    ...
                    "line": 0,
                    "event": "#",
                    "message": "        security_context_t user_context;",
                    "verbosity_level": 1
                },
                {
                    "file_name": "",
        ...
        },
        {
            ...
            "events": [
                ...
                },
                {
                    ...
                    "message": "'GLIB_VERSION_MIN_REQUIRED' macro redefined",
                    "verbosity_level": 0
                },
                {
                    "file_name": "",
                    "line": 0,
                    "event": "#",
                    "message": "#define GLIB_VERSION_MIN_REQUIRED GLIB_VERSION_2_30",
                    "verbosity_level": 1
                },
                {
                    "file_name": "",
                ...
                },
                {
                    ...
                    "line": 0,
                    "event": "#",
                    "message": "# define GLIB_VERSION_MIN_REQUIRED      (GLIB_VERSION_CUR_STABLE)",
                    "verbosity_level": 1
                },
                {
                    "file_name": "",
        ...
        },
        {
            ...
            "events": [
                ...
                },
                {
                    ...
                    "line": 0,
                    "event": "#",
                    "message": "typedef security_context_t lu_security_context_t;",
                    "verbosity_level": 1
                },
                {
                    "file_name": "",
        ...
        },
        {
            ...
            "events": [
                ...
                },
                {
                    ...
                    "line": 0,
                    "event": "#",
                    "message": "gboolean lu_util_fscreate_save(security_context_t *ctx,",
                    "verbosity_level": 1
                },
                {
                    "file_name": "",
        ...
        },
        {
            ...
            "events": [
                ...
                },
                {
                    ...
                    "line": 0,
                    "event": "#",
                    "message": "void lu_util_fscreate_restore(security_context_t ctx);",
                    "verbosity_level": 1
                },
                {
                    "file_name": "",
        ...
        },
        {
            ...
            "events": [
                ...
                },
                {
                    ...
                    "line": 0,
                    "event": "#",
                    "message": "lu_util_fscreate_save(security_context_t *ctx, struct lu_error **error)",
                    "verbosity_level": 1
                },
                {
                    "file_name": "",
        ...
        },
        {
            ...
            "events": [
                ...
                },
                {
                    ...
                    "line": 0,
                    "event": "#",
                    "message": "lu_util_fscreate_restore(security_context_t ctx)",
                    "verbosity_level": 1
                },
                {
                    "file_name": "",
        ...
        },
        {
            ...
            "events": [
                ...
                },
                {
                    ...
                    "line": 0,
                    "event": "#",
                    "message": "                if (matchpathcon(path, mode, &ctx) < 0) {",
                    "verbosity_level": 1
                },
                {
                    "file_name": "",
            ...
            "events": [
                {
                    ...
                    "message": "incompatible pointer to integer conversion initializing 'Py_ssize_t' (aka 'long') with an expression of type 'void *'",
                    "verbosity_level": 0
                },
                {
                    "file_name": "",
        ...
        },
        {
            ...
            "events": [
                ...
                },
                {
                    ...
                    "line": 0,
                    "event": "#",
                    "message": "        name = PYSTRTYPE_ASSTRING(attr_name);",
                    "verbosity_level": 1
                },
                {
                    "file_name": "",
        ...
        },
        {
            ...
            "events": [
                ...
                },
                {
                    ...
                    "line": 0,
                    "event": "#",
                    "message": "        attr = PYSTRTYPE_ASSTRING(item);",
                    "verbosity_level": 1
                },
                {
                    "file_name": "",
