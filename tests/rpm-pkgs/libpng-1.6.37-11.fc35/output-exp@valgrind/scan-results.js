{
    "scan": {
        ...
        "store-results-to": "/root/aufover-benchmark/workdir-for-sync/rpm-pkgs/libpng-1.6.37-11.fc35/valgrind/output",
        "time-created": "2022-11-23 22:53:45",
        "time-finished": "2022-11-23 23:02:10",
        "tool": "csmock",
        "tool-args": "'/usr/bin/csmock' '-o' '/root/aufover-benchmark/workdir-for-sync/rpm-pkgs/libpng-1.6.37-11.fc35/valgrind/output' '-f' '/root/aufover-benchmark/workdir-for-sync/rpm-pkgs/libpng-1.6.37-11.fc35/libpng-1.6.37-11.fc35.src.rpm' '-r' 'fedora-35-x86_64' '-t' 'valgrind' '--valgrind-timeout=8' '--keep-going'",
            ...
            "events": [
                {
                    ...
                    "line": 0,
                    "event": "note",
                    "message": "while executing process 694 with arguments: --relaxed ./contrib/testpngs/crashers/badcrc.png",
                    "verbosity_level": 1
                },
                {
        ...
        },
        {
            ...
            "events": [
                ...
                },
                {
                    ...
                    "line": 1674,
                    "event": "note",
                    "message": "Address 0x4b7064f is 47 bytes inside a block of size 4,096 alloc'd",
                    "verbosity_level": 1
                },
                {
