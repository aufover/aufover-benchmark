{
    "scan": {
        ...
        "store-results-to": "/home/mockbuilder/aufover-benchmark/workdir-for-sync/rpm-pkgs/diffutils-3.8-1.fc35/divine/output",
        "time-created": "2023-01-26 19:32:36",
        "time-finished": "2023-01-26 19:40:42",
        "tool": "csmock",
        "tool-args": "'/usr/bin/csmock' '-o' '/home/mockbuilder/aufover-benchmark/workdir-for-sync/rpm-pkgs/diffutils-3.8-1.fc35/divine/output' '-f' '/home/mockbuilder/aufover-benchmark/workdir-for-sync/rpm-pkgs/diffutils-3.8-1.fc35/diffutils-3.8-1.fc35.src.rpm' '-r' 'fedora-35-x86_64' '-t' 'divine' '--divine-timeout=8' '--keep-going'",
    ...
    "defects": [
        ...
        },
        {
            ...
            "events": [
                {
                    "file_name": "diffutils-3.8/lib/getrandom.c",
                    "line": 166,
                    "column": 10,
                    "event": "warning",
        ...
        },
        {
            ...
            "events": [
                {
                    "file_name": "diffutils-3.8/lib/nl_langinfo.c",
                    "line": 342,
                    "column": 10,
                    "event": "warning",
        ...
        },
        {
            ...
            "events": [
                ...
                },
                {
                    ...
                    "line": 0,
                    "event": "#",
                    "message": "  300|               signal (sig[j], sig[j] == SIGTSTP ? stophandler : sighandler);",
                    "verbosity_level": 1
                },
                {
                    "file_name": "",
                    "line": 0,
                    "event": "#",
                    "message": "  301|->             siginterrupt (sig[j], 0);",
                    "verbosity_level": 1
                },
                {
                    "file_name": "",
