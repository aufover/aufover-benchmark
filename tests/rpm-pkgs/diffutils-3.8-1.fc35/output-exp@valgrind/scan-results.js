{
    "scan": {
        ...
        "store-results-to": "/root/aufover-benchmark/workdir-for-sync/rpm-pkgs/diffutils-3.8-1.fc35/valgrind/output",
        "time-created": "2022-11-23 22:36:06",
        "time-finished": "2022-11-23 22:53:26",
        "tool": "csmock",
        "tool-args": "'/usr/bin/csmock' '-o' '/root/aufover-benchmark/workdir-for-sync/rpm-pkgs/diffutils-3.8-1.fc35/valgrind/output' '-f' '/root/aufover-benchmark/workdir-for-sync/rpm-pkgs/diffutils-3.8-1.fc35/diffutils-3.8-1.fc35.src.rpm' '-r' 'fedora-35-x86_64' '-t' 'valgrind' '--valgrind-timeout=8' '--keep-going'",
            ...
            "events": [
                {
                    ...
                    "line": 0,
                    "event": "note",
                    "message": "while executing process 9986 with arguments: 1",
                    "verbosity_level": 1
                },
                {
            ...
            "events": [
                {
                    ...
                    "line": 0,
                    "event": "note",
                    "message": "while executing process 10039",
                    "verbosity_level": 1
                },
                {
            ...
            "events": [
                {
                    ...
                    "line": 0,
                    "event": "note",
                    "message": "while executing process 11532",
                    "verbosity_level": 1
                },
                {
            ...
            "events": [
                {
                    ...
                    "line": 0,
                    "event": "note",
                    "message": "while executing process 12263",
                    "verbosity_level": 1
                },
                {
            ...
            "events": [
                {
                    ...
                    "line": 0,
                    "event": "note",
                    "message": "while executing process 12281",
                    "verbosity_level": 1
                },
                {
            ...
            "events": [
                {
                    ...
                    "line": 0,
                    "event": "note",
                    "message": "while executing process 12708",
                    "verbosity_level": 1
                },
                {
            ...
            "events": [
                {
                    ...
                    "line": 0,
                    "event": "note",
                    "message": "while executing process 4245 with arguments: -Ix -I\\ a b",
                    "verbosity_level": 1
                },
                {
            ...
            "events": [
                {
                    ...
                    "line": 0,
                    "event": "note",
                    "message": "while executing process 3096 with arguments: d e f",
                    "verbosity_level": 1
                },
                {
