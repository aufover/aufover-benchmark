{
    "scan": {
        ...
        "store-results-to": "/home/mockbuilder/aufover-benchmark/workdir-for-sync/rpm-pkgs/libarchive-3.5.2-2.fc35/symbiotic/output",
        "time-created": "2023-02-01 13:44:02",
        "time-finished": "2023-02-01 15:00:46",
        "tool": "csmock",
        "tool-args": "'/usr/bin/csmock' '-o' '/home/mockbuilder/aufover-benchmark/workdir-for-sync/rpm-pkgs/libarchive-3.5.2-2.fc35/symbiotic/output' '-f' '/home/mockbuilder/aufover-benchmark/workdir-for-sync/rpm-pkgs/libarchive-3.5.2-2.fc35/libarchive-3.5.2-2.fc35.src.rpm' '-r' 'fedora-35-x86_64' '-t' 'symbiotic' '--symbiotic-timeout=8' '--keep-going'",
    ...
    "defects": [
        ...
        },
        {
            ...
            "events": [
                {
                    "file_name": "libarchive-3.5.2/libarchive/archive_read_support_format_mtree.c",
                    "line": 695,
                    "column": 10,
                    "event": "warning[-Wunused-but-set-variable]",
                    "message": "variable 'detected_bytes' set but not used",
                    "verbosity_level": 0
                },
                {
                    "file_name": "",
                    "line": 0,
                    "event": "#",
                    "message": "        ssize_t detected_bytes = 0, len, nl;",
                    "verbosity_level": 1
                },
                {
                    "file_name": "",
                ...
                },
                {
                    ...
                    "line": 0,
                    "event": "#",
                    "message": "  694|   \tssize_t avail, ravail;",
                    "verbosity_level": 1
                },
                {
                    "file_name": "",
                    "line": 0,
                    "event": "#",
                    "message": "  695|-> \tssize_t detected_bytes = 0, len, nl;",
                    "verbosity_level": 1
                },
                {
                    "file_name": "",
                    "line": 0,
                    "event": "#",
                    "message": "  696|   \tint entry_cnt = 0, multiline = 0;",
                    "verbosity_level": 1
                },
                {
                    "file_name": "",
                    "line": 0,
                    "event": "#",
                    "message": "  697|   \tint form_D = 0;/* The archive is generated by `NetBSD mtree -D'",
                    "verbosity_level": 1
                }
            ]
        }
