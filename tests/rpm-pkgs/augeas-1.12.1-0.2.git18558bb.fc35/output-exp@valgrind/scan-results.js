{
    "scan": {
        ...
        "store-results-to": "/root/aufover-benchmark/workdir-for-sync/rpm-pkgs/augeas-1.12.1-0.2.git18558bb.fc35/valgrind/output",
        "time-created": "2022-11-23 18:44:35",
        "time-finished": "2022-11-23 18:50:54",
        "tool": "csmock",
        "tool-args": "'/usr/bin/csmock' '-o' '/root/aufover-benchmark/workdir-for-sync/rpm-pkgs/augeas-1.12.1-0.2.git18558bb.fc35/valgrind/output' '-f' '/root/aufover-benchmark/workdir-for-sync/rpm-pkgs/augeas-1.12.1-0.2.git18558bb.fc35/augeas-1.12.1-0.2.git18558bb.fc35.src.rpm' '-r' 'fedora-35-x86_64' '-t' 'valgrind' '--valgrind-timeout=8' '--keep-going'",
    ...
    "defects": [
        ...
        },
        {
            ...
            "events": [
                {
                    "file_name": "augeas-1.12.0/src/memory.h",
                    "line": 26,
                    "event": "included_from",
                ...
                {
                    "file_name": "augeas-1.12.0/src/internal.h",
                    "line": 229,
                    "column": 19,
                    "event": "warning[-Winline]",
                    "message": "inlining failed in call to 'streqv': call is unlikely and code size would grow",
                    "verbosity_level": 0
                },
                {
                    "file_name": "",
                    "line": 0,
                    "event": "#",
                    "message": "  229 | static inline int streqv(const char *a, const char *b) {",
                    "verbosity_level": 1
                },
                {
                    "file_name": "",
                ...
                },
                {
                    ...
                    "line": 0,
                    "event": "#",
                    "message": "  294 |     if (streqv(ext, \".json\")) {",
                    "verbosity_level": 1
                },
                {
                    "file_name": "",
